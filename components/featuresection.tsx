...
import { CardDemo } from "./langcards";
        ...
        <div className="relative  py-10 lg:py-40 max-w-7xl mx-auto">
            <div className="px-8">
                <h4 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-medium text-black dark:text-white">
                    Designed to help you learn as fast as possible
                </h4>

                <p className="text-sm lg:text-base  max-w-2xl  my-4 mx-auto text-neutral-500 text-center font-normal dark:text-neutral-300">
                    Learn trending technologies and become proficient with our easy-to-understand, learner-oriented lessons. Our comprehensive courses are designed to help you master
                    the latest tools and techniques, ensuring you stay ahead in the ever-evolving tech landscape.
                </p>
            </div>
...
export const SkeletonThree = () => {
    return (
        <Link
            href="https://www.youtube.com/@neocloudtech"
            target="__blank"
...
//             markers: [
//                 // longitude latitude
//                 { location: [9.0563, 7.4985], size: 0.1 },
